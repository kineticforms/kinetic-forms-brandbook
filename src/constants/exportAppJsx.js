// Self-contained single-file App.jsx for the "Export Source Code" zip download.
// This version omits download buttons to prevent recursive string inception.
// Keep in sync with the actual component structure when making changes.
export function getExportAppJsx() {
